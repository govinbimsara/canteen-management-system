...
?>
                ...
                <h2 class="ph-block-title">Ready Orders</h2>
                    ...
                    <table id="orders" style="width:100%" class="table table-dark table-striped">
                        ...
                        $sql = "SELECT * FROM orders WHERE order_status='Ready' ORDER BY order_number DESC";
    ...
    cursor: pointer;">Change status</button>
            ...
            <div>
                <form action="includes/status-bulk-ready.inc.php" method="POST">
