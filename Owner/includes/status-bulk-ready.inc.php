<?php
    // Changes the status of the whole Ready list 
    if(isset($_POST["submit"])){
        ...
        $sql = "SELECT * FROM orders WHERE order_status='Ready'";
        ...
        if($result){ 
            foreach($result as $row)
            {
                ...
                $sql3 = "UPDATE orders SET order_status = ? WHERE order_status='Ready';";
                ...
                header("location: ../orders-ready.php?error=noerror");

            }
        }
    }else{
        header("location: ../orders-ready.php?error=noentry");
        exit();
    }