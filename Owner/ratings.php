...
$query1 = "SELECT product.product_name, review_table.product_id FROM product INNER JOIN review_table ON product.product_id = review_table.product_id";
$result1 = mysqli_query($conn, $query1);

if(isset($_GET['food'])){
    $a = $_GET['food'];
    $query2 = "SELECT * FROM product WHERE product_id = $a";
...
<form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="GET">
    <select name="food" id="food">
            <option disabled selected value> -- select food -- </option>
                <?php foreach ($result1 as $foods) { ?>
                    ...
                    <option value="<?= $foods['product_id'] ?>"><?= $foods['product_name'] ?></option>
                                <?php
                            }
                            ?>
    </select>
    ...
    <div class="container">
        <div class="card">
        <div class="card-header"><b><?php echo $b; ?></b></div>
            <div class="card-body">
                <div class="row">
