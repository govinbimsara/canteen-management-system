...
?>
                ...
                <h2 class="ph-block-title">Orders List</h2>
                    ...
                    <table id="orders" style="width:100%" class="table table-dark table-striped">
                        ...
                        $sql = "SELECT * FROM orders WHERE order_status='Processing' ORDER BY order_number DESC";
    ...
    cursor: pointer;">Change status</button>
            ...
            <div>
                <form action="includes/status-bulk-process.inc.php" method="POST">
